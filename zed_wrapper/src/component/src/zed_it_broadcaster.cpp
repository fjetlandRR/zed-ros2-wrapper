...
void ZedItBroadcaster::initSubscribers() {
    ...
    if (rightRawSub  && (!mRawRightSub || !mRawRightInfoSub)) {
        ...
        mRawRightInfoSub = create_subscription<sensor_msgs::msg::CameraInfo>(
                    rightCamInfoRawTopic, mVideoQos,
...
void ZedItBroadcaster::initPublishers() {
    ...
    mRgbPub = image_transport::create_camera_publisher(this, mRgbTopic, mVideoQos.get_rmw_qos_profile());
    ...
    mRightPub = image_transport::create_camera_publisher(this, mRightTopic, mVideoQos.get_rmw_qos_profile());
    ...
    mLeftPub = image_transport::create_camera_publisher(this, mLeftTopic, mVideoQos.get_rmw_qos_profile());
    ...
    mRawRgbPub = image_transport::create_camera_publisher(this, mRawRgbTopic, mVideoQos.get_rmw_qos_profile());
    ...
    mRawRightPub = image_transport::create_camera_publisher(this, mRawRightTopic, mVideoQos.get_rmw_qos_profile());
    ...
    mRawLeftPub = image_transport::create_camera_publisher(this, mRawLeftTopic, mVideoQos.get_rmw_qos_profile());
    ...
    mDepthPub = image_transport::create_camera_publisher(this, mDepthTopic, mDepthQos.get_rmw_qos_profile());
